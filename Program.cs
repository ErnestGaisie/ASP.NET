...
List<GameDto> games = [
    new (1, "Street Fghter II", "Fighting", 19.99M, new DateOnly(1992, 7, 15)),
    new (2, "Final Fantasy II", "RPG", 69.99M, new DateOnly(1992, 2, 15)),
    new (3, "Astro Bot II", "Platformer", 509.99M, new DateOnly(1992, 9, 15)),
];
